...
import GoogleMapSelector from "@/components/cliente/google-map-selector";
                                    ...
                                    <Draggable key={lote.id} draggableId={lote.id} index={index}>
                                        {(provided) => (
                                            <div
                                                ...
                                                className="group relative bg-card rounded-xl border border-border/60 shadow-sm hover:shadow-md transition-all p-3"
                                            >
                                                <div className="flex items-center gap-4">
                                                    <div {...provided.dragHandleProps} className="text-muted-foreground/30 group-hover:text-muted-foreground/60 transition-colors">
                                                    ...
                                                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                                        <Button variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground hover:text-primary" onClick={(e) => { e.stopPropagation(); startEditing(lote); }}>
